        ...
        <div className="relative z-10">
          ...
          <div className="space-y-6">
            ...
            <button
              ...
              className="w-full bg-blue-600 hover:bg-[#0F24E6]   disabled:bg-blue-400 text-white font-medium py-3 px-6 rounded-lg disabled:cursor-not-allowed transition-colors"
            >
              Join Room
            </button>
          </div>
